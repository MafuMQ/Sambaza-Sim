...
from demos.demo import load_examples_from_database
        ...
        if is_tech_comparison:
            ...
            if use_multi_level:
                res = run_simulation(
                    ...
                    wage_proportions=params.get('wage_proportions', None),
                    surplus_proportions=params.get('surplus_proportions', None),
